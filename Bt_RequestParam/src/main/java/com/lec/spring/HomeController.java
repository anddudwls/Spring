...
//	public void findMember(String id, Model model,  String name) {  // 순서 무관!
//		System.out.println("member/find : id=" + id + ", name=" + name);
//		model.addAttribute("id", id);
//		model.addAttribute("name", name);
//	}
	
	// 숫자 타입이면 parsing 하여 받을수 있다.
//	public void findMember(double id, String name, Model model) {   // primitive 타입인데, parameter 에 없는 경우 에러 발생
//	public void findMember(Double id, String name, Model model) {   // wrapper 타입이면, parameter 없어도 null 값으로 받아옴.
//		System.out.println("member/find : id=" + id + ", name=" + name);
//		model.addAttribute("id", id);
//		model.addAttribute("name", name);
//	}
